    ...
    with Session(engine) as session:
        ...
        if not setting_check:
            ...
            settings = [
                ...
                Setting(key="hub_intake_qr", value="HUB-INTAKE-SCAN"),
                ...
                Setting(key="imaging_station_capacity", value="5"),
                Setting(key="pretreat_station_capacity", value="5"),
                Setting(key="qa_station_capacity", value="5"),
